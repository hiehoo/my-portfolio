...
const About = () => {
  return (
    <div id='about' className='w-full md:h screen p-2 flex items-baseline py-16'>
        <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
            ...
            <p className='py-2 text-gray-600'>Fascinated with how intricate programming can be I was quickly drawn
            ...
            <div className='w-full h-auto m-auto shadow-xl shadow-gray-400 rounded-xl flex items-center justify-center p-4 hover:scale-105 ease-in duration-300'>
                <Image className='rounded-xl' src="/../public/assets/laptop.avif" alt="/" width={1364} height={1705} />
            </div>
        </div>
    </div>
  )
